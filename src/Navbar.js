...
export default function Navbar(props) {
  ...
  <div className="container-fluid">
    <a className="navbar-brand" href="/Textarea">om salunke</a>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <button className="nav-a active" aria-current="page" href="/about">Home</button>
        </li>
        <li className="nav-item">
  ...
  <input className="form-check-input" type="checkbox" onClick={props.ontoggle} role="switch" id="flexSwitchCheckDefault"/>
